...
class BruteCollinearPointsTest {
    ...
    void createsASegmentWithFourPoints() {
        ...
        LineSegment[] actualLS = new BruteCollinearPoints(points).segments();
    ...
    @Test
    void createsTwoSegmentsWhenFivePointsAreCollinear() {
        ...
        LineSegment[] expectedLS = new LineSegment[] {new LineSegment(p, s), new LineSegment(q, t)};
        StringBuilder sb = new StringBuilder();
        for (LineSegment l : expectedLS) {
            sb.append(l).append("\n");
        }
